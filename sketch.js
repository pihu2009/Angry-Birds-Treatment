...
textSize(50)
text("YOU WIN!!",800,350)
text("Press R to restart",800,500)
if(keyCode === 82)
{
	reset()
}
...
if(gamestate==="end")
{
	World.add(myworld,pig1.body);
pig1.visibilty=255;
World.add(myworld,pig2.body);
pig2.visibilty=255;
}
}
...
gamestate="end"
score=0;
Matter.Body.setPosition(bird1.body,{x:285,y:520})
...
Matter.Body.setPosition(log1.body,{x:1150,y:550})
...
Matter.Body.setPosition(log2.body,{x:1150,y:385})
Matter.Body.setPosition(box5.body,{x:1150,y:300})
Matter.Body.setPosition(log3.body,{x:1100,y:300})
Matter.Body.setPosition(log4.body,{x:1200,y:300,})
Matter.Body.setAngle(log1.body,PI)
Matter.Body.setAngle(log2.body,PI)
Matter.Body.setAngle(log3.body,-PI/4)
Matter.Body.setAngle(log4.body,PI/4)
}
